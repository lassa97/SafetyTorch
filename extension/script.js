...
chrome.webRequest.onBeforeRequest.addListener(
    function(details) {
        console.log(JSON.stringify(details.initiator));
        let warning = document.getElementById("warning");
        let advice = document.getElementById("advice");
        if (details.initiator == "http://127.0.0.1:8080") {
            warning.innerHTML = `<b>127.0.0.2</b> es peligroso. <br>Categoría: <b>spam</b><sup>1</sup>`;
            advice.innerHTML = `¿Qué es el <a href="https://www.youtube.com/watch?v=uhzV5-iFb5E&list=PLr5GsywSn9d8pUMODmSqxtJ27fGH6N4Z-&index=5" target="_blank">phishing</a>?`;
            advice.innerHTML += `<br><br>`
            advice.innerHTML += `[1]: Aparece en la lista <i>dnsbl.example.com</i>.`
